...
public class ClientBillPurchaseReqPackager extends ISO87BPackager {
    ...
    public ClientBillPurchaseReqPackager() {
        super();
    ...
    protected class F48Packager extends ISOBasePackager 
	{
		protected ISOFieldPackager fld48[] = 
			{
				new org.jpos.iso.IF_CHAR(2,     "Kode Group"),
	        	new org.jpos.iso.IF_CHAR(12,    "Kode Produk"),
	        	new org.jpos.iso.IF_CHAR(12,    "No HP	")
	    	};
    	public F48Packager () 
    	{
        	super();
